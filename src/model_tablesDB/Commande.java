...
public class Commande {
    ...
    public Commande(long COM_ID) {
        this.COM_ID = COM_ID;
    }

    public Commande(long COM_ID, long adrId, long traId, long cliId, long fraId, int staType, long adr_adrId, LocalDate comDate, float DECIMAL, int comModePaiement, String comIp, String comChampLibre, LocalDate comDateExpedition, String comNumeroDeSuivi) {
        this.COM_ID = COM_ID;
        this.adrId = adrId;
        this.traId = traId;
        this.cliId = cliId;
